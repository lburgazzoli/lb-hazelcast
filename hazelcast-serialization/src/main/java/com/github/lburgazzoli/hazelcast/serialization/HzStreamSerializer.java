...
public class HzStreamSerializer<T,S> extends HzSerializer<T,S> implements StreamSerializer<T> {

    protected HzStreamSerializer(final Class<T> type, int typeId) {
        super(type, typeId, null );
    }

    protected HzStreamSerializer(final Class<T> type, int typeId, Supplier<? extends S> supplier) {
