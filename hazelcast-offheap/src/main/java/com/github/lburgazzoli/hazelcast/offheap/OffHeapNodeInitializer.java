...
public class OffHeapNodeInitializer extends DefaultNodeInitializer {
    ...
    public void afterInitialize(Node node) {
        ...
        String size = node.getConfig().getProperty("com.github.lburgazzoli.hazelcast.offheap.size");
        String lazy = node.getConfig().getProperty("com.github.lburgazzoli.hazelcast.offheap.lazyInit");
